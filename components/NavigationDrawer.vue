<template>
  ...
  >
    <v-row class="fill-height" no-gutters style="overflow: hidden">
      ...
      <v-list class="grow" v-if="mini == false && $route.name == ''">
        <!-- {{ this.page }} -->
      ...
      <v-card
        ...
        v-if="mini == false && $route.name == 'main'"
      >
      ...
      <v-card
        ...
        width="520"
        class="d-flex justify-center"
        v-if="mini == false && $route.name == 'chat'"
      >
        <v-list subheader>
      ...
      <UserConfig v-if="mini == false && $route.name == '/users/you'" />
      ...
      <v-card
        ...
        width="520"
        class="d-flex justify-center"
        v-if="mini == false && $route.name == 'communities'"
      >
        <v-container max-width="500" class="pa-1">
          <!-- <v-col cols="9"> -->
          <v-item-group v-model="selected" multiple>
